...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    playSongWithTracklist: (song, params, tracklist) =>
      dispatch(playSongWithTracklist(song, params, tracklist)),
    openAddToPlaylistForm: () => dispatch(openAddToPlaylistForm()),
    fetchModalPlaylists: (songToAddId) =>
      dispatch(fetchModalPlaylists(songToAddId)),
